...
INSERT INTO "new_Bundle" ("applyOnSubscriptions", "bundleType", "createdAt", "id", "name", "numberOfRenewals", "prioritySequence", "productSelectionType", "selectedProductIds", "shop", "shortcode", "showWidget", "status", "title", "updatedAt") SELECT "applyOnSubscriptions", "bundleType", "createdAt", "id", "name", "numberOfRenewals", "prioritySequence", "productSelectionType", "selectedProductIds", "shop", "shortcode", "showWidget", "status", "title", "updatedAt" FROM "Bundle";
DROP TABLE "Bundle";
